...
// Ex 1
// function parseCode<V>(c: Code<V>, trees: seq<Tree<V>>): seq<Tree<V>>
//   ensures |parseCode(c, trees)| > 0
// {
//   match c {
//     case CLf(v) => [Leaf(v)] + trees
//     case CSNd(v) =>
//       if |trees| >= 2 then [SingleNode(v, trees[1])] + trees[2..]
//       else trees
//     case CDNd(v) =>
//       if |trees| >= 3 then [DoubleNode(v, trees[2], trees[1])] + trees[3..]
//       else trees
//   }
// }
